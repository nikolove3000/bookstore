                ...
                {avatarOpen && (
                  <div className="nav-avatar-menu">
                    ...
                    {user?.role?.includes("ADMIN") && (
                      <>
                        <Link to="/admin/books" className="nav-avatar-item" onClick={() => setAvatarOpen(false)}>
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                        ...
                        <Link to="/admin/orders" className="nav-avatar-item" onClick={() => setAvatarOpen(false)}>
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                            <rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" />
                            <rect x="3" y="14" width="7" height="7" /><rect x="14" y="14" width="7" height="7" />
                          </svg>
                        ...
                        <Link to="/admin/users" className="nav-avatar-item" onClick={() => setAvatarOpen(false)}>
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
